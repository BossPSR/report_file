...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 29, 2020 at 10:27 AM
...
(4, '', '', 0, 'USD', 4, '', '', '2020-01-29 14:16:21', '2020-02-27 14:16:21', 1);
...
(1, 4, 5, 'G-Shock', 'อวกาศ', '1000', 'iu', 1, '2020-01-29 16:25:14', '2020-01-29 16:25:14');
...
INSERT INTO `tbl_upload_store` (`id`, `userId`, `store_id`, `file_name`, `is_check`, `create_at`, `update_at`, `path`, `price_file`, `grade`, `status_cp`, `status_main_search`) VALUES
(1, 4, 'ST-1', 'logo1.png', 0, '2020-01-29 14:16:21', NULL, 'uploads/Store/logo1.png', '50', 'A', 'complete', 1);
...
CREATE TABLE `tbl_user` (
  ...
  `password` varchar(255) DEFAULT NULL,
  `file_name` varchar(255) DEFAULT NULL,
  `free_forever` tinyint(1) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(4, '4444555666112', '150', 'test@gmail.com', '0877777887', 'เทสอย่าง มีระบบ', 'e10adc3949ba59abbe56e057f20f883e', 'public/frontend/assets/img/profile/2.png', 1, '2020-01-29 07:10:23'),
