...
<?php  $poster = $this->db->get_where('tbl_poster',['id'=>$id])->row_array(); ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <form action="Poster_Edit_com" method="POST" enctype="multipart/form-data" >
                                    ...
                                    <div class="row">
                                        <div class="col-xl-4 col-md-6 col-12 mb-1">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="text" name="name_file" value="<?php echo $poster['name_file']; ?>"  class="form-control" placeholder="Enter NamePoster" required>
                                                <input type="hidden" name="id" value="<?php echo $poster['id']; ?>"  class="form-control" placeholder="Enter NamePoster" required>
                                            </fieldset>
                                        </div>
                                        <div class="col-xl-4 col-md-6 col-12 mb-1">
                                            <fieldset class="form-group">
                                                ...
                                                <br>
                                                <img src="./uploads/poster/<?php echo $poster['file_name']; ?>" style="width: auto;height: 200px;   padding-bottom: 10px;">
