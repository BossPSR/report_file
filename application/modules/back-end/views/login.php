...
<head>
    ...
    <!-- BEGIN: Page CSS-->
    <link rel="stylesheet" type="text/css" href="public/backend/assets/css/core/menu/menu-types/vertical-menu.css">
    <link rel="stylesheet" type="text/css" href="public/backend/assets/css/core/colors/palette-gradient.css">
    <link rel="stylesheet" type="text/css" href="public/backend/assets/css/pages/authentication.css">
    <!-- END: Page CSS-->
                        ...
                        <div class="card bg-authentication rounded-0 mb-0">
                            <div class="row m-0">
                                <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                                    <img src="public/backend/assets/images/pages/login.png" alt="branding logo">
                                </div>
