        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">Store For sell grade C</h2>
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="back_dashboard">Dashboard</a>
                                </li>
                                <li class="breadcrumb-item active">Store For sell grade C
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Store For sell grade C</h4>
                            </div>
                                        ...
                                        <table class="table zero-configuration">
                                            ...
                                            <?php foreach ($store as $store) { ?>
                                               <?php if($store['price_file']=="" ): ?>
                                                <?php elseif ($store['price_file'] &&  $store['grade']=='C') :?>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="exampleModalLabel">StoreFile grade C</h5>
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <form action="add_to_upload_main_search" method="POST" class="form-horizontal">
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <input type="hidden" class="form-control" name="store_check" value="c">
                                                                        <input type="hidden" class="form-control" name="id" value="<?php echo $store['id']; ?>">
