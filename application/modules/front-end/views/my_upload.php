                        ...
                        <?php foreach ($documents as $key => $documents) : ?>
                            <div class="col-3 text-right margin-5 product">
                                ...
                                <div class="boxdel">
                                    ...
                                    <a href="my-upload-edit?upload_preview_id=<?php echo $documents['upload_id']; ?>&id=<?php echo $_GET['id']; ?>" class="btn btn-warning" class="boxdel"><i class="fa fa-pencil" aria-hidden="true" style="font-size: 26px;"></i></a>
                                    ...
                                    <a onclick="confirmalert2('<?php echo $documents['upload_id']; ?>')" class="btn btn-danger" class="boxdel delete-s remove"><i class="fa fa-trash-o" aria-hidden="true" style="font-size: 26px;"></i></a>
                                </div>
