<!--footer area start-->
<footer class="footer_widgets" style="background-color: #f9f9f9;">
...
<script type="text/javascript">
    ...
    //         });
    //     }
    // } else if ($order['status_pay'] == 0 && $order['check_time_not_pay'] == 1 && date("Y-m-d H:i:s") > date("Y-m-d H:i:s", strtotime("+ 12 hours", $order['create_at']))) {
    //     setInterval(function() {
    //         checkStatus24();
    //     }, 3000);

    //     function checkStatus24() {
    //         console.log('2');
